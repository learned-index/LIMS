...
public:
    ...
    // void getAccResult(Point &, double, mainRef_Point &);
    // void getIdistanceResult(double, double);
...
RangeQuery::RangeQuery(Point &queryPoint, double radius, mainRef_Point &mainRef_point, vector<int> &rangeQueryRes, CalCirclePos &mainRefPtCircle, vector<CalCirclePos> &ref_query)
{
...
void RangeQuery::DoRangeQuery(unsigned i, vector<vector<int> > &rank_list, unsigned long long queryRange, mainRef_Point &mainRef_point, vector<int> &rangeQueryRes){
